...
export interface ConversationState {
    ...
    // Request deduplication (per-conversation, moved from routes module-level state)
    lastProcessedUserMessage?: string;
    lastProcessedFunctionOutputCallId?: string;
    createdCallIds: Set<string>;  // Tool call IDs created by this conversation
}
