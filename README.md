...
To give Lumo access to your files and let it execute commands locally, set `cli.localActions.enabled: true` in your `config.yaml` (see [Local Actions](#local-actions-cli)).  
